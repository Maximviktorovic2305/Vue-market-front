<script lang="ts" setup>
	...
	import WashesCatalogItem from '../components/modules/catalog/WashesCatalogItem.vue'
...
<template>
	<div class="px-[250px] bg-bgDark">
		<div class="mt-[60px] text-[18px] mb-[50px] pt-5">
			...
			<span class="text-primary">Смесители</span>
		</div>
		<Cart />

		<div class="pb-[30px]">
			<div class="flex items-center gap-[164px]">
				<div class="text-secondary text-[36px] font-bold pb-10">Смесители</div>
			...
			<div class="flex">
				...
				<div class="w-[70%]">
					<div class="grid grid-cols-2 gap-5 pt-10">
						<WashesCatalogItem
							:item="item"
							v-for="item of washesCatalogItems"
							:key="item.title" />
					</div>
				</div>
			</div>
